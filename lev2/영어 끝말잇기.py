...
5	["hello", "observe", "effect", "take", "either", "recognize", "encourage", "ensure", "establish", "hang", "gather",
...
def solution(n, words):
    ...
    for i, word in enumerate(words[1:]):
        if w[-1] != word[0] or word in speak:
    ...
    #     speak.append(words[i-1])
    #     if words[i-1][-1] != words[i][0] or words[i] in speak:
    #         return [i%n+1, i//n+1]
    # return [0, 0]
...
import timeit
avg_time = 0.
tests = [[3, ["tank", "kick", "know", "wheel", "land", "dream", "mother", "robot", "tank"]],
         [5, ["hello", "observe", "effect", "take", "either", "recognize", "encourage", "ensure", "establish",
