...
예를 들면,
cpp and - and senior and pizza 500은
cpp로 코딩테스트를 봤으며, 경력은 senior 이면서 소울푸드로 pizza를 선택한 지원자 중 코딩테스트 점수를 500점 이상 받은 사람은 모두 몇 명인가?를 의미합니다.

[입출력 예]
info	                                query	                                            result
["java backend junior pizza 150",       ["java and backend and junior and pizza 100",       [1,
"python frontend senior chicken 210",   "python and frontend and senior and chicken 200",   1,
"python frontend senior chicken 150",   "cpp and - and senior and pizza 250",               1,
"cpp backend senior pizza 260",         "- and backend and senior and - 150",               1,
"java backend junior chicken 80",       "- and - and - and chicken 100",                    2,
"python backend senior chicken 50"]	    "- and - and - and - 150"]                          4]
...
def solution(info, query):
    hash_table = get_hash_table(info)
    ...
    for row in query:
        ...
        if k in hash_table:
            bound = get_lower_bound(hash_table[k], int(r[-1]))
            print(f"data: {hash_table[k]}, low: {bound}, query: {r[-1]}")
            answer.append(len(hash_table[k][bound:]))
        else:
            answer.append(0)
    return answer
    ...
    #                 else:
    #                     start = (start + end) // 2 + 1
    #             print(f"data: {data}, low: {start}, query: {qry_score}")
...
print(solution(["java backend junior pizza 150", "python frontend senior chicken 210", "python frontend senior chicken 150", "cpp backend senior pizza 260", "java backend junior chicken 80", "python backend senior chicken 50"],
               ["- and backend and senior and - 150", "- and - and - and - 270"]))
